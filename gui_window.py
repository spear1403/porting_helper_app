...
class GuiWindow(object):
    def __init__(self, master):
        ...
        self.checkmark = tk.PhotoImage(file = "check.png")
        self.blank = tk.PhotoImage(file = "blank.png")
        self.icon = tk.PhotoImage(file = "android-icon.png")
        ...
        self.frame6 = tk.LabelFrame(self.master)
        self.status_text = tk.Label(self.frame6, text="Status:            archives: ---   images: ---   audio files: ---   videos: ---", font='Helvetica 12')
        self.status_text.pack(side=tk.LEFT, pady=2, padx=2)
        self.frame6.pack(fill=tk.X, pady=2, padx=10)
        ...
        self.C3_label.grid(row=5, column=1, sticky=tk.W)
        ...
        self.C6_label.grid(row=6, column=1, sticky=tk.W)
        ...
        self.C4_label.grid(row=7, column=1, sticky=tk.W)
        ...
        self.C5_label.grid(row=8, column=1, sticky=tk.W)
        ...
        self.icon_image = tk.Button(self.icon_image_frame, image=self.icon)
